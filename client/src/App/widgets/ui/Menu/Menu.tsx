...
export const Menu = () => {
    ...
    return (
        <div className={cls.menu}>
            <img className={cls.menu_block} src={homeText} alt="" />
            <Button className={cls.btn} size='s' onClick={handleShowButton}>
                {
                        ...
                        <div className={cls.modals_block}>
                            ...
                            <article>
                                ...
                                <div>
                                    ...
                                    <p className={cls.desc}>Стоимость нашей Еды
                                        <span>зависит только от ее</span> количества. Качество<p >всегда на высоте!</p></p>
                                </div>
                            </article>
                        </div>
                    )
